...
4. If OPSX/OpenSpec is configured, create or continue planning artifacts before implementation. Otherwise proceed directly from the issue.
...
10. Create a PR with summary, tests, linked issue, and OPSX/OpenSpec references when relevant.
